...
const TodoComponent = (props) => {
  ...
  return (
    <Droppable droppableId="todos">
        {(provided)=> (<div className="max-h-[60%] overflow-auto shadow-lg"
        ...
        >
            {props.todos.length >0? props.todos.map((todo, index) => (
                ...
                {(provided)=> (
                    ...
                    <img src={cross} alt="" className="ml-auto md:hidden delete " onClick={() => props.handleDelete(todo.id)}/>
                    </div>
                )}
                </Draggable>
            )): props.currentTab !== "all"? <p className={darkTheme?"p-4 bg-[#24283c] mb-2":"p-4 bg-white mb-2"}>No {props.currentTab} items</p>:""}
